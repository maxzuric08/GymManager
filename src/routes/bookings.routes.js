...
const { requireUser, requireAdminOrActiveInstructor } = require("../middleware/role.middleware");

router.get("/my-bookings", verifyToken, requireUser, getUserBookings);
router.get("/class/:classId/students", verifyToken, requireAdminOrActiveInstructor, getClassStudents);
